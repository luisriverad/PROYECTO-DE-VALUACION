...
export const sb = configurado ? createClient(SUPABASE_URL, SUPABASE_ANON) : null;
...
export function esAdmin(perfil) { return perfil?.rol === "admin"; }
...
async function marcarAcceso(userId) {
...
export function useSesion() {
  ...
  useEffect(() => {
    ...
    const { data: sub } = sb.auth.onAuthStateChange((_e, sesion) => aplicar(sesion));
