      ...
      {s.insumos.length === 0 ? (
        ...
        <table className="w-full">
          <thead><tr>
            ...
            <Th align="left" w="10%">Unidad</Th><Th>Costo por unidad</Th><Th w="40"></Th>
          </tr></thead>
          <tbody>
            {s.insumos.map((it, i) => (
              <tr key={it.id}>
                ...
                <Td align="left"><TxtIn value={it.unidad} onChange={(v) => up((n) => { n.insumos[i].unidad = v; })} /></Td>
                <Td bold>{money(m.insumoUnit[it.id], 4)}</Td>
